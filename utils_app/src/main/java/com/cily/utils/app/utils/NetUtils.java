...
public class NetUtils {
         ...
         * 根据APN区分网络类型
         */
        public static final byte NET_TYPE_WIFI = 1;// wifi

        public static final byte NET_TYPE_CTNET = 2;// ctnet

        public static final byte NET_TYPE_CTWAP = 3;// ctwap

        public static final byte NET_TYPE_CMWAP = 4;// cmwap

        public static final byte NET_TYPE_UNIWAP = 5;// uniwap,3gwap

        public static final byte NET_TYPE_CMNET = 6;// cmnet

        public static final byte NET_TYPE_UNIET = 7;// uninet,3gnet

        /**
         * 根据运营商区分网络类型
         */
        public static final byte NET_TYPE_CTC = 10;// ctwap,ctnet

        public static final byte NET_TYPE_CUC = 11;// uniwap,3gwap,uninet,3gnet

        public static final byte NET_TYPE_CM = 12;// cmwap,cmnet
        ...
        public static byte curNetworkType = NET_TYPE_NONE;
        ...
        public static String getNetworkProxyUrl() {
             ...
             */
            if (curNetworkType == NET_TYPE_WIFI) {
                return null;
            }
        ...
        public static boolean isCtcNetwork(byte type) {
            if (type == NET_TYPE_CTWAP || type == NET_TYPE_CTNET) {
                return true;
            } else {
                return false;
            }
        ...
        public static boolean isCucNetwork(byte type) {
            if (type == NET_TYPE_UNIWAP || type == NET_TYPE_UNIET) {
                return true;
            } else {
                return false;
            }
        ...
        public static boolean isCmbNetwork(byte type) {
            if (type == NET_TYPE_CMWAP || type == NET_TYPE_CMNET) {
                return true;
            } else {
                return false;
            }
        ...
        public static byte getNetworkOperators(byte type) {
            if (type == NET_TYPE_NONE) {
                return NET_TYPE_NONE;
            } else if (type == NET_TYPE_WIFI) {
                return NET_TYPE_WIFI;
            } else if (type == NET_TYPE_CTNET || type == NET_TYPE_CTWAP) {
                return NET_TYPE_CTC;
            } else if (type == NET_TYPE_CMWAP || type == NET_TYPE_CMNET) {
                return NET_TYPE_CM;
            } else if (type == NET_TYPE_UNIWAP || type == NET_TYPE_UNIET) {
                return NET_TYPE_CUC;
            } else {
                return NET_TYPE_NONE;
            }
